...
export default function Calculator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[#cee0e7] dark:bg-gray-900">
      {/* Center the calculator within the screen */}
      <Card className="w-full max-w-md p-6 bg-[#e7f0f0] dark:bg-gray-800 shadow-lg rounded-lg">
